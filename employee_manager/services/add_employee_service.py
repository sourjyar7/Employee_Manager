...
class EmployeeAdder:
    ...
    def add_employee(self):
        employee_data=Employee(self.employee.firstname,self.employee.lastname,self.employee.department,self.employee.email,self.employee.mobile_no,self.employee.doj)
